...
def main():
    ...
    # ____________________ ITERATED EXPERIMENTS ____________________
    ...
    # ____________________ SINGLE EXPERIMENT WITH MAP ____________________
    ...
    # ____________________ MULTIPLE EXPERIMENTS ____________________
