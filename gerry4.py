...
def main():
    ...
    for run in range(runs):
        for percentage in percentages:
            ...
            grid = Grid(12, districts, perc, False, False)
    ...
    plt.figure()
    plt.title('Gerrymandering results for the plurality rule without hotspots')
    plt.plot(results_hotspots.keys(), results_hotspots.values(), 'r-o', label="with proportion limit")
    plt.plot(results_no_hotspots.keys(), results_no_hotspots.values(), 'b-o', label="without proportion limit")
    plt.xlabel('Actual percentage')
    plt.ylabel('Gerrymandered percentage')
    plt.legend(loc="upper left")
    plt.savefig("results/graphs/plurality_no_hotspots.png")
    ...
    plt.figure()
    plt.title('Gerrymandering results for the borda rule without hotspots')
    plt.plot(results_hotspots.keys(), results_hotspots.values(), 'r-o', label="with proportion limit")
    plt.plot(results_no_hotspots.keys(), results_no_hotspots.values(), 'b-o', label="without proportion limit")
    plt.xlabel('Actual percentage')
    plt.ylabel('Gerrymandered percentage')
    plt.legend(loc="upper left")
    plt.savefig("results/graphs/borda_no_hotspots.png")
    ...
    plt.figure()
    plt.title('Gerrymandering results for the copeland rule without hotspots')
    plt.plot(results_hotspots.keys(), results_hotspots.values(), 'r-o', label="with proportion limit")
    plt.plot(results_no_hotspots.keys(), results_no_hotspots.values(), 'b-o', label="without proportion limit")
    plt.xlabel('Actual percentage')
    plt.ylabel('Gerrymandered percentage')
    plt.legend(loc="upper left")
    plt.savefig("results/graphs/copeland_no_hotspots.png")
