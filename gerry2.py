...
def main():
    ...
    plt.figure()
    plt.title('Gerrymandering results for the plurality rule without proportion restriction')
    ...
    plt.savefig("results/graphs/plurality_no_proportion.png")
    ...
    plt.figure()
    plt.title('Gerrymandering results for the borda rule without proportion restriction')
    plt.plot(results_hotspots.keys(), results_hotspots.values(), 'r-o', label="with hotspots")
    plt.plot(results_no_hotspots.keys(), results_no_hotspots.values(), 'b-o', label="without hotspots")
    plt.xlabel('Actual percentage')
    plt.ylabel('Gerrymandered percentage')
    plt.legend(loc="upper left")
    plt.savefig("results/graphs/borda_no_proportion.png")
    ...
    plt.figure()
    plt.title('Gerrymandering results for the copeland rule without proportion restriction')
    plt.plot(results_hotspots.keys(), results_hotspots.values(), 'r-o', label="with hotspots")
    plt.plot(results_no_hotspots.keys(), results_no_hotspots.values(), 'b-o', label="without hotspots")
    plt.xlabel('Actual percentage')
    plt.ylabel('Gerrymandered percentage')
    plt.legend(loc="upper left")
    plt.savefig("results/graphs/copeland_no_proportion.png")
