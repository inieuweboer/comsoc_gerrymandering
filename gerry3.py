...
def main():
    ...
    plt.figure()
    plt.title('Gerrymandering results for the plurality rule with hotspots')
    ...
    plt.savefig("results/graphs/plurality_hotspots.png")
    ...
    plt.figure()
    plt.title('Gerrymandering results for the borda rule with hotspots')
    plt.plot(results_hotspots.keys(), results_hotspots.values(), 'r-o', label="with proportion limit")
    plt.plot(results_no_hotspots.keys(), results_no_hotspots.values(), 'b-o', label="without proportion limit")
    plt.xlabel('Actual percentage')
    plt.ylabel('Gerrymandered percentage')
    plt.legend(loc="upper left")
    plt.savefig("results/graphs/borda_hotspots.png")
    ...
    plt.figure()
    plt.title('Gerrymandering results for the copeland rule with hotspots')
    plt.plot(results_hotspots.keys(), results_hotspots.values(), 'r-o', label="with proportion limit")
    plt.plot(results_no_hotspots.keys(), results_no_hotspots.values(), 'b-o', label="without proportion limit")
    plt.xlabel('Actual percentage')
    plt.ylabel('Gerrymandered percentage')
    plt.legend(loc="upper left")
    plt.savefig("results/graphs/copeland_hotspots.png")
